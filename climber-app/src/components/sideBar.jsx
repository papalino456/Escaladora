...
export default function SideBar() {
    return (
      <div className="fixed top-0 left-0 h-screen w-16 bg-white flex flex-col items-center pt-6">
        ...
        <nav className='flex flex-col mt-10'>
          ...
          <a href="#" className="mb-6">
            <DocumentTextIcon className="h-6 w-6 mb-12 text-black hover:text-orange-600" />
          </a>
          <a href="#">
